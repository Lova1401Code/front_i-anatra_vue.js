      ...
      <div class="pd-20 card-box mb-30">
        <div class="clearfix mb-20">
          <div class="pull-left">
            ...
            <p>
              Add <code>.table .table-bordered</code> for borders on all sides
      ...
      <div class="pd-20 card-box mb-30">
        <div class="clearfix mb-20">
          <div class="pull-left">
            ...
            <p>
              Add <code>.table .table-striped</code> to add zebra-striping to
        ...
        <div class="clearfix mb-20">
          <div class="pull-left">
            ...
            <p>
              ...
              <code>.table .table-responsive</code> Or, pick a maximum
        ...
        <div class="clearfix mb-20">
          <div class="pull-left">
            ...
            <p>
              Use classes
              <code
                >( .table-active, .table-success, .table-info, .table-warning,
                .table-danger )</code
              >
